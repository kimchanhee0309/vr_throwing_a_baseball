...
namespace VirtualGrasp.Controllers
{
    ...
    [HelpURL("https://docs.virtualgrasp.com/unity_vg_ec_scripthand." + VG_Version.__VG_VERSION__ + ".html")]
    public class VG_EC_ScriptHand : VG_ExternalController
    {
        ...
        public VG_EC_ScriptHand(int avatarID, VG_HandSide side, Transform origin)
        {
            m_avatarID = avatarID;
            m_handType = side;
            m_origin = origin;
